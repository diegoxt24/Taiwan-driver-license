...
for idx, m in enumerate(matches):
    ...
    # Fallback default question stem for pure sign questions where text is only option choices
    if not stem:
...
print(f'Reparsed {len(car_qs)} Car Questions with fallback stem!')
