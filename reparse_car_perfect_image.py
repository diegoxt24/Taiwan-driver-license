...
for idx, m in enumerate(matches):
    ...
    if q_y0 is not None:
        ...
        for img_rect, xref in page_imgs:
            ...
            if dist < min_dist and dist < 65: # Tight vertical proximity threshold (<65pt)
                min_dist = dist
                best_xref = xref
                best_rect = img_rect
...
print(f'Reparsed {len(car_qs)} Car Questions with PERFECT spatial image matching for sign questions!')
