...
for idx, m in enumerate(matches):
    ...
    # Split strictly on full-width or half-width option numbering
    ...
    if len(opt_parts) >= 7:
        ...
        # Fallback split for full width numbers like （1） （2） （3）
...
print(f'Reparsed {len(car_qs)} Car Questions with PERFECT verbatim option splitting!')
